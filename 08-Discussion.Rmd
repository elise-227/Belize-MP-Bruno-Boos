...
# road <- all %>%
#   filter(variable == "Distance to Roads")
# roaddf <- cbind(road, st2, by = c("species" ="Common.Name"))
# 
# bio <- all %>%
#   filter(variable == "Mean Biomass")
# biodf <- cbind(bio, st2, by = c("species" ="Common.Name"))
# 
# bio <- all %>%
#   filter(variable == "Distance to Streams")
# biodf <- cbind(bio, st2, by = c("species" ="Common.Name"))
```
