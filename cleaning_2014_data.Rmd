...
```
Errors in data found that need to fix -- 410C2 is repeated 410C needed to be fixed in the days operational.

Record 2234 is an obs after the camera was removed so need to removed probably. A couple data points are like this need to look into!!!!
