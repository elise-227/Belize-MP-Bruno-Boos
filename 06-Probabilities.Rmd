...
#prediction list
predlist <- list()
predlist <- c(cguan_anthro_env, gtinamou_anthro_env, jaguar_anthro_env, rqdove_anthro_env, wncoati_anthro_env)

names(predlist) <- c("Crested guan", "Great tinamou", "Jaguar", "Ruddy quail-dove", "White-nosed coati")
...
df_psi$Speciesname <- c("Crested guan", "Great tinamou", "Jaguar", "Ruddy quail-dove", "White-nosed coati")
colnames(df_psi) <- c("psi", "se", "NA", "Speciesname")
df_psi <- df_psi[,-3]
df_psinew_2 <- df_psi

save(df_psinew_2, file = "df_psi_new2.Rda")
...
#prediction list
modlist <- list()
modlist <- c(cguan_anthro_env, gtinamou_anthro_env, jaguar_anthro_env, rqdove_anthro_env, wncoati_anthro_env)

names(modlist) <- c("Crested guan", "Great tinamou", "Jaguar", "Ruddy quail-dove", "White-nosed coati")
...
save(df_pnew2, file = "detprobsnew2.Rda")
