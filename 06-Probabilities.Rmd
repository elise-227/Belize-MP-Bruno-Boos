...
#prediction list
predlist <- list()
predlist <- c(agouti_anthro_env, gcurassow_anthro_env, gfox_anthro_env, ghdove_anthro_env, ocelot_anthro_env, oturkey_anthro_env, paca_anthro_env, puma_anthro_env, rbdeer_anthro_env, wtdeer_anthro_env)

names(predlist) <- c("Agouti", "Great curassow", "Gray fox", "Gray-headed dove", "Ocelot", "Ocellated turkey", "Paca", "Puma", "Red brocket", "White-tailed deer")
...
df_psi$Speciesname <- c("Agouti", "Great curassow", "Gray fox", "Gray-headed dove", "Ocelot", "Ocellated turkey", "Paca", "Puma", "Red brocket", "White-tailed deer")
colnames(df_psi) <- c("psi", "se", "NA", "Speciesname")
df_psi <- df_psi[,-3]
df_psinew_1 <- df_psi

save(df_psinew_1, file = "df_psi_new1.Rda")
...
#prediction list
modlist <- list()
modlist <- c(agouti_anthro_env, gcurassow_anthro_env, gfox_anthro_env, ghdove_anthro_env, ocelot_anthro_env, oturkey_anthro_env, paca_anthro_env, puma_anthro_env, rbdeer_anthro_env, wtdeer_anthro_env)

names(modlist) <- c("Agouti", "Great curassow", "Gray fox", "Gray-headed dove", "Ocelot", "Ocellated turkey", "Paca", "Puma", "Red brocket", "White-tailed deer")
...
save(df_pnew1, file = "detprobsnew1.Rda")
write.csv(df_pnew1, file = "detprobsnew1.csv")
