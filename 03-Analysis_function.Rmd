...
# save(df_psi, file = "df_psi.Rda")
# write.csv(df_psi, file = "df_psi.csv")
...
#prediction list
modlist <- list()
modlist <- c(agouti_anthro_env, cguan_anthro_env, GHDove_anthro_env, grayfox_anthro_env, greatcura_anthro_env, jaguar_anthro_env, ocellatedturkey_anthro_env, ocelot_anthro_env, Paca_anthro_env, puma_anthro_env, redbrockdeer_anthro_env, wnosedcoati_anthro_env, wtdeer_anthro_env)

names(modlist) <- c("Agouti", "Crested Guan", "Gray-headed Dove", "Gray Fox","Great Curassow", "Jaguar", "Ocellated Turkey", "Ocelot", "Paca", "Puma", "Red Brocket Deer", "White-nosed Coati", "White-tailed Deer")
...
# 
save(df_p, file = "detprobs.Rda")
write.csv(df_p, file = "detprobs.csv")
