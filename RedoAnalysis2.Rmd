...
season <- matrix(nrow=372,ncol =144)
check4 <- as.vector(check3$`1`)
season[1,1:length(as.vector(check3$`1`))] <- as.vector(check3$`1`)

range <- 1:372
for (r in range) {
    season[r,1:length(as.vector(check3[r]))] <- as.vector(check3[r])
}
