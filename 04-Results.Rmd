...
modlist2 <- c(agouti_anthro_env, gcurassow_anthro_env, gfox_anthro_env, ghdove_anthro_env, ocelot_anthro_env, oturkey_anthro_env, paca_anthro_env, puma_anthro_env, rbdeer_anthro_env, wtdeer_anthro_env)

names(modlist2) <- c("Agouti", "Great curassow", "Gray fox", "Gray-headed dove", "Ocelot", "Ocellated turkey", "Paca", "Puma", "Red brocket", "White-tailed deer")
...
save(df_log, file = 'df_logging1.Rda')
...
CI_new1 <- rbind(df_int, df_log, df_roads, df_bio, df_streams, df_NDVI, df_season, df_dist, df_site)

save(CI_new1, file = "effects_new1.Rda")
