...
```{r modlists}
#set directory to location of models
setwd("E:/Model Outputs/March 27")
...
# load("greattina_anthro_env.RData")
# load("margay_anthro_env.RData")
# load("ruddyqd_anthro_env.RData")
...
modlist2 <- c(BfourOpossum_anthro_env, CommonOpossum_anthro_env, NbArmadillo_anthro_env, RnWoodrail_anthro_env, Wthrush_anthro_env)
#c(collaredpeccary_anthro_env, greattina_anthro_env, margay_anthro_env, ruddyqd_anthro_env, stripedskunk_anthro_env, tayra_anthro_env, tigerheron_anthro_env, wlippedpeccary_anthro_env)

names(modlist2) <- c("Brown four-eyed opossum", "Common opossum", "Nine-banded armadillo", "Russet-naped woodrail", "Wood thrush")
  #c("Collared peccary", "Great tinamou", "Margay", "Ruddy quail-dove", "Striped hog-nosed skunk", "Tayra", "Bare-throated tiger heron", "White-lipped peccary")
...
CI3 <- rbind(df_int, df_log, df_roads, df_bio, df_streams, df_NDVI, df_season, df_dist, df_site)

save(CI3, file = "effects3.Rda")
...
ggsave("Logging_plot_bw3.png", units = "in", width = 8, height = 9)
...
df_psi4 <- data.frame(psi = c(0.51,	0.29, 0.80, 0.52, 0.67,	0.70, 0.37, 0.71, 0.32, 0.44, 0.69), se = c(0.015, 0.012, 0.008, 0.013, 0.011, 0.011, 0.013, 0.009, 0.009, 0.011, 0.01), Speciesname = c("Agouti", "Gray-headed dove", "Great curassow", "Jaguar", "Ocellated turkey", "Ocelot", "Paca", "Puma", "Red brocket", "White-nosed coati", "White-tailed deer"))

psi <- rbind(df_psi, df_psi2, df_psi3, df_psi4)
...
#need to run "Bare-throated tiger heron", "Collared Peccary", "Great tinamou", "Margay", "Ruddy quail-dove" "Striped hog-nosed skunk", "Tayra", "White-lipped Peccary"
