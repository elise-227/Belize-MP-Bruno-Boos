...
modlist2 <- c(collaredpeccary_anthro_env, greattina_anthro_env, margay_anthro_env, ruddyqd_anthro_env, stripedskunk_anthro_env, tayra_anthro_env, tigerheron_anthro_env, wlippedpeccary_anthro_env)

names(modlist2) <- c("Collared peccary", "Great tinamou", "Margay", "Ruddy quail-dove", "Striped hog-nosed skunk", "Tayra", "Bare-throated tiger heron", "White-lipped peccary")
...
CI2 <- rbind(df_int, df_log, df_roads, df_bio, df_streams, df_NDVI, df_season, df_dist, df_site)

save(CI2, file = "effects2.Rda")
