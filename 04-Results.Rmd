...
tiff("effectsplotbw3.tiff", units = "in", width = 8, height = 12, res = 300)
p <- grid.arrange(arrangeGrob(Roads_plot, Biomass_plot, Streams_plot, NDVI_plot, Season_plot, NatD_plot, nrow = 3), ncol = 1, heights = c(10, 1))
dev.off()
