...
camop2014 <- cameraOperation(camop2014, stationCol = "site", setupCol = "Date.Placement", retrievalCol = "Last.Record_clean", occasionStartTime = 0 , dateFormat = "%Y-%m-%d", writecsv = FALSE)
