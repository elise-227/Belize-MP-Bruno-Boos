...
datafor2019[datafor2019$site == "909A",]$Date.Placement <- as.Date("2019-12-02","%Y-%m-%d")
datafor2019[datafor2019$site == "909A",]$Last.record <- as.Date("2020-01-06","%Y-%m-%d")
datafor2019[datafor2019$site == "909A",]$Date.Removed <- as.Date("2020-01-06","%Y-%m-%d")
datafor2019[datafor2019$site == "909B",]$Date.Placement <- as.Date("2020-01-06","%Y-%m-%d")
datafor2019[datafor2019$site == "909B",]$Last.record <- as.Date("2020-02-06","%Y-%m-%d")
datafor2019[datafor2019$site == "909B",]$Date.Removed <- as.Date("2020-02-06","%Y-%m-%d")
datafor2019[datafor2019$site == "909C",]$Date.Placement <- as.Date("2020-02-18","%Y-%m-%d")
datafor2019[datafor2019$site == "909C",]$Last.record <- as.Date("2020-04-11","%Y-%m-%d")
datafor2019[datafor2019$site == "909C",]$Date.Removed <- as.Date("2020-04-11","%Y-%m-%d")
datafor2019[datafor2019$site == "910G",]$Date.Placement <- as.Date("2019-08-24","%Y-%m-%d")

datafor2019[datafor2019$site == "909A" & datafor2019$Month == 1,]$Year <- 2020 
datafor2019[datafor2019$site == "909B" | datafor2019$site == "909C",]$Year <- 2020 
...
datafor2019_errors <- datafor2019_visit %>%
  mutate(errors = ifelse(obsdate > Last.record, TRUE, FALSE)) %>%
  mutate(opp_errors = ifelse(obsdate < Date.Placement, TRUE, FALSE)) %>%
  drop_na(Date.Placement) %>%
  drop_na(Location)
summary(datafor2019_errors$errors)
summary(datafor2019_errors$opp_errors)


data2019_final <- datafor2019_errors %>%
  mutate(date_time_obs = paste(obsdate, sprintf("%.2f", round(Hour.Exact, 2)))) %>%
  select(1:2,7:34, date_time_obs)

camdataprep_2019 <- data2019_final %>%
  select(site, Date.Placement, Days, Last.record, Northing.y, Easting.y)
camopdataframe2019 <- camdataprep_2019[!duplicated(camdataprep_2019$site), ]




write.csv(camopdataframe2019, "camop_2019.csv", row.names = FALSE)
write.csv(data2019_final, "data2019_final.csv", row.names = FALSE)

sitecovs2019 <- left_join(camopdataframe2019, cameraops2019, c("site"="Name"))

write.csv(sitecovs2019, "sitecovs2019.csv", row.names = FALSE)
```
909A month is wrong 
...
datafor2020[datafor2020$Name == "05B",]$Last.record <- as.Date("2020-05-22","%Y-%m-%d")
datafor2020[datafor2020$Name == "04B",]$Last.record <- as.Date("2020-05-22","%Y-%m-%d")
datafor2020[datafor2020$Name == "05B",]$Date.Removed <- as.Date("2020-05-22","%Y-%m-%d")
datafor2020[datafor2020$Name == "04B",]$Date.Removed <- as.Date("2020-05-22","%Y-%m-%d")

datafor2020[datafor2020$Name == "12E",]$Last.record <- as.Date("2020-09-09","%Y-%m-%d")
datafor2020[datafor2020$Name == "11B",]$Last.record <- as.Date("2020-04-15","%Y-%m-%d")

datafor2020[datafor2020$Name == "06E",]$Date.Removed <- as.Date("2020-08-22","%Y-%m-%d")
datafor2020[datafor2020$Name == "06E",]$Last.record <- as.Date("2020-08-22","%Y-%m-%d")
datafor2020[datafor2020$Name == "06E",]$Date.Placement <- as.Date("2020-07-18","%Y-%m-%d")

datafor2020[datafor2020$Name == "05F",]$Date.Placement <- as.Date("2020-08-08","%Y-%m-%d")
datafor2020[datafor2020$Name == "02H",]$Date.Placement <- as.Date("2020-09-10","%Y-%m-%d")

datafor2020 <- datafor2020[-2501, ]
...
data2020_final <- datafor2020_errors %>%
  mutate(date_time_obs = paste(obsdate, sprintf("%.2f", round(Hour.Exact, 2)))) %>%
  select(1:9,11:15,17:21,25:36,obsdate,visit, date_time_obs)

camdataprep_2020 <- data2020_final %>%
  select(Name, Date.Placement, Days, Last.record, Northing.y, Easting.y)
camopdataframe2020 <- camdataprep_2020[!duplicated(camdataprep_2020$Name), ]




write.csv(camopdataframe2020, "camop_2020.csv", row.names = FALSE)
write.csv(data2020_final, "data2020_final.csv", row.names = FALSE)

sitecovs2020 <- left_join(camopdataframe2020, cameraops2020, by = "Name")

write.csv(sitecovs2020, "sitecovs2020.csv", row.names = FALSE)
```
