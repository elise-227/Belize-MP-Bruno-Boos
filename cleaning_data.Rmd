...
Errors with cam 710E (maybe other cams too) Have to do with "endday". This date is different than the date removed. Date removed would not result in these errors.
