...
camop2017 <- cameraOperation(camopdataframe2017, stationCol = "site", setupCol = "First_Obs", retrievalCol = "Last.Record_clean", dateFormat = "%Y-%m-%d", writecsv = FALSE)


detect_hist_2017_grayfox <- detectionHistory(recordTable = data2017_final, species = "Gray fox", camOp= camop2017, output = "count", stationCol = "site", speciesCol = "species.name", day1 ="survey", recordDateTimeCol = "date_time_obs", recordDateTimeFormat =  "%Y-%m-%d %H.%M", timeZone = "UTC", occasionLength = 113, includeEffort = TRUE, scaleEffort = TRUE, writecsv = FALSE)
